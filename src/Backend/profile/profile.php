...
<div class="flex flex-row gap-x-4 m-4">
    ...
    <div class="w-1/2 flex flex-col bg-white shadow-xl rounded gap-y-3 p-8">
        ...
        <form action="password_post.php" method="POST">
            <div class="flex flex-col gap-y-2">
                <div class="flex flex-col gap-y-1">
                    <label for="password" class="text-base font-semibold">Current Password</label>
                    <input type="password" name="current_password" value="<?=$select_fetch_assoc['name']?>" class="border rounded w-full px-4 py-2 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Enter Full Name">
                </div>
                <div class="flex flex-col gap-y-1">
                    <label for="gender" class="text-base font-semibold block">Gender</label>
                    <div class="flex flex-row gap-x-4">
